...
prompts_neutral_id = [
    ...
    "Tuliskan refleksi seseorang setelah mengalami hari nya dia"
]

prompt_neutral_id_1 = [
    "Ceritakan tentang terakhir kali kamu libur. Jelaskan secara rinci apa yang terjadi dan kegiatan yang kamu lakukan.",
    "Ceritakan tentang terakhir hari kerja yang lalu. Jelaskan secara rinci apa yang terjadi dan kegiatan yang kamu lakukan.",
    "Ceritakan tentang akhir pekan terakhir kamu. Jelaskan secara rinci apa yang terjadi dan kegiatan yang kamu lakukan.",
    "Ceritakan tentang terakhir kali kamu menghabiskan waktu bersama teman-teman. Jelaskan secara rinci apa yang terjadi dan kegiatan yang kamu lakukan.",
    "Ceritakan tentang terakhir kali kamu menghabiskan waktu bersama keluarga. Jelaskan secara rinci apa yang terjadi dan kegiatan yang kamu lakukan.",
    "Ceritakan tentang terakhir kali kamu menghabiskan waktu sendirian. Jelaskan secara rinci apa yang terjadi dan kegiatan yang kamu lakukan.",
    "Ceritakan tentang pengalaman terbaru kamu. Jelaskan secara rinci apa yang terjadi.",
    "Ceritakan tentang terakhir kali kamu mengalami sesuatu yang tidak terduga. Jelaskan secara rinci apa yang terjadi.",
    # best one out of the four"Ceritakan tentang terakhir kali seseorang merasakan emosi pada hari libur. Pastikan untuk mengasih banyak detail tentang emosi yang dirasakan.",
    ...
    # "Jelaskan bagaimana seseorang akan bereaksi ketika bertemu kembali dengan seseorang.",
    # "Bagaimana Anda akan menanggapi undangan dari seseorang?",
    # "Bagaimana Anda menggambarkan sesuatu yang baru saja terjadi?",
    # "Ceritakan pengalaman terbaru ketika Anda merasakan emosi yang kuat."
